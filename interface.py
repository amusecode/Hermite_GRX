...
class HermiteGRXInterface(CodeInterface, GravitationalDynamicsInterface, StoppingConditionInterface):
    ...
    def get_dt_param():
        ...
        function.addParameter('dt_param', dtype='float64', direction=function.OUT, description="the timestep scaling factor")
    ...
    def set_dt_param():
        ...
        """
        function = LegacyFunctionSpecification()
        function.addParameter('dt_param', dtype='float64', direction=function.IN, description="the timestep scaling factor")
        function.result_type = 'int32'
        return function
    ...
    def get_time():
        ...
        """
        function = LegacyFunctionSpecification()
        function.addParameter('time', dtype='float64', direction=function.OUT, description="the current simulation time")
        function.result_type = 'int32'
        return function
    ...
    def set_time():
        ...
        """
        function = LegacyFunctionSpecification()
        function.addParameter('time', dtype='float64', direction=function.IN, description="the current simulation time")
        function.result_type = 'int32'
        return function
    ...
    def get_light_speed():
        ...
        """
        function = LegacyFunctionSpecification()
        function.addParameter('lightspeed', dtype='float64', direction=function.OUT, description="the current speed of light")
        function.result_type = 'int32'
        return function
    ...
    def set_light_speed():
	    ...
	    """
	    function = LegacyFunctionSpecification()
	    function.addParameter('lightspeed', dtype='float64', direction=function.IN, description="the current speed of light")
	    function.result_type = 'int32'
	    return function
    @legacy_function
    def get_integrator():
        ...
        """
        function = LegacyFunctionSpecification()
        function.addParameter('integrator', dtype='string', direction=function.OUT, description="the current integrator")
        function.result_type = 'int32'
        return function
    ...
    def set_integrator():
        ...
        """
        function = LegacyFunctionSpecification()
        function.addParameter('integrator', dtype='string', direction=function.IN, description="the current integrator")
        function.result_type = 'int32'
        return function
    ...
    def get_perturbation():
        ...
        """
        function = LegacyFunctionSpecification()
        function.addParameter('interaction', dtype='string', direction=function.OUT, description="the current perturbation")
        function.result_type = 'int32'
        return function
    ...
    def set_perturbation():
        ...
        """
        function = LegacyFunctionSpecification()
        function.addParameter('interaction', dtype='string', direction=function.IN, description="the current perturbation")
        function.result_type = 'int32'
        return function
    ...
    def get_num_threads():
        ...
        """
        function = LegacyFunctionSpecification()
        function.addParameter('num_threads', dtype='int32', direction=function.OUT, description="the number of threads")
        function.result_type = 'int32'
        return function
    ...
    def set_num_threads():
        ...
        """
        function = LegacyFunctionSpecification()
        function.addParameter('num_threads', dtype='int32', direction=function.IN, description="the number of threads")
        function.result_type = 'int32'
        return function
    ...
    def get_total_energy_with():
        ...
        """
        function = LegacyFunctionSpecification()
        function.addParameter('type', dtype='string', direction=function.IN, description="the perturbation with which to calculate")
        function.addParameter('etot', dtype='float64', direction=function.OUT, description="the current total energy")
        function.result_type = 'int32'
        return function
    ...
    def get_total_linear_momentum_with():
        ...
        function = LegacyFunctionSpecification()
        function.addParameter('type', dtype='string', direction=function.IN, description="the perturbation with which to calculate")
        function.addParameter('px', dtype='float64', direction=function.OUT, description="the momentum in x")
        function.addParameter('py', dtype='float64', direction=function.OUT, description="the momentum in y")
        function.addParameter('pz', dtype='float64', direction=function.OUT, description="the momentum in z")
        function.result_type = 'int32'
        return function
    ...
    def new_large_particle():
        ...
        function.addParameter('id', dtype='int32', direction=function.OUT, description="the identifier")
        function.addParameter('mass', dtype='float64', direction=function.IN, description="the mass")
        function.addParameter('x', dtype='float64', direction=function.IN, description="the x position")
        function.addParameter('y', dtype='float64', direction=function.IN, description="the y position")
        function.addParameter('z', dtype='float64', direction=function.IN, description="the z position")
        function.addParameter('vx', dtype='float64', direction=function.IN, description="the x velocity")
        function.addParameter('vy', dtype='float64', direction=function.IN, description="the y velocity")
        function.addParameter('vz', dtype='float64', direction=function.IN, description="the z velocity")
        function.addParameter('radius', dtype='float64', direction=function.IN, description="the radius")
        function.result_type='int32'
        return function
...
class HermiteGRX(GravitationalDynamics):
    ...
    def define_particle_sets(self, object):
        object.define_super_set('particles', ['large_particles', 'small_particles'], index_to_default_set = 1)
